// Custom override of core global-header — deploy/fork banner removed.
// Upstream: src/components/layout/global-header.tsx
// When upstream changes that file, diff it against this one and merge as needed.
